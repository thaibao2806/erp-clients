  ...
  return (
    <div style={{ padding: 10 }}>
      <Row justify="space-between" align="middle">
        <Col>
          <Title level={3}>Xem chi tiết đề xuất vật tư sửa chữa</Title>
        </Col>
        <Col>
          <Dropdown
      ...
      >
        <Panel header="Thông tin sổ kho" key="1">
          <Space direction="vertical" size="middle">
            ...
            <div>Nội dung: Tháng 3 - Phòng Nhân sự</div>
...
export default RepairSuppliesDetail;
