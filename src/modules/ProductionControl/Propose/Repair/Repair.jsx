...
const Repair = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      fixed: isMobile ? "left" : false,
      render: (text, record) => (
        <Link to={`/pm/de-xuat/sua-chua-chi-tiet/${record.key}`}>{text}</Link>
      ),
    },
    {
      title: "Ngày chứng từ",
  ...
  const mobileColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <Link
            to={`/pm/de-xuat/sua-chua-chi-tiet/${record.key}`}
    ...
    },
    {
      ...
      render: (type, record) => (
        <div>
          <Tag
            color={type === "SC" ? "orange" : "red"}
            style={{ fontSize: 10, marginBottom: 4 }}
          >
            {type === "SC" ? "Sửa chữa" : "Thanh lý"}
          </Tag>
          <br />
          <Tag
            color={
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                <Link
                  to={`/pm/de-xuat/sua-chua-chi-tiet/${item.key}`}
              ...
              <div style={{ fontSize: 12, color: "#666", lineHeight: 1.4 }}>
                ...
                <div style={{ marginBottom: 2 }}>
                  <Text strong>Bộ phận:</Text> {item.department}
                </div>
            ...
            >
              <Tag
                color={item.assetType === "SC" ? "orange" : "red"}
                style={{
                  fontSize: 10,
                  marginBottom: 4,
                  borderRadius: "4px",
              ...
              >
                {item.assetType === "SC" ? "Sửa chữa" : "Thanh lý"}
              </Tag>
