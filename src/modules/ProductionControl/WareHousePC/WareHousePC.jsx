...
const WareHousePC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      fixed: isMobile ? "left" : false,
      render: (text, record) => (
        <Link to={`/pm/so-kho-chi-tiet/${record.key}`}>{text}</Link>
      ),
    },
    {
      title: "Ngày chứng từ",
  ...
  const mobileColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <Link
            to={`/pm/so-kho-chi-tiet/${record.key}`}
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                <Link
                  to={`/pm/so-kho-chi-tiet/${item.key}`}
              ...
              <div style={{ fontSize: 12, color: "#666", lineHeight: 1.4 }}>
                ...
                <div style={{ marginBottom: 2 }}>
                  <Text strong>Đơn vị:</Text> {item.division}
                </div>

                <div style={{ marginBottom: 2 }}>
                  <Text strong>Loại vật tư:</Text>
    ...
    <div style={{ padding: isMobile ? 8 : 5 }}>
      ...
      >
        <div style={{ padding: "8px 0" }}>
          ...
          >
            <DeleteOutlined />
            <span>Xóa sổ kho đã chọn ({selectedRowKeys.length})</span>
          </div>
        </div>
      </Drawer>
