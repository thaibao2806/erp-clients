...
const ProjectsModal = ({ open, onCancel, onSubmit, initialValues }) => {
  ...
  return (
    ...
    title={
      <span style={{ fontSize: 25, fontWeight: 600 }}>
        {initialValues ? "Cập nhật dự án" : "Thêm dự án"}
      </span>
    }
      open={open}
      onCancel={() => {
    ...
    >
      <Form form={form} layout="vertical">
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item name="name" label="Sản phẩm" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
          ...
          <Col span={12}>
            <Form.Item name="name" label="Ngày bắt đầu" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
