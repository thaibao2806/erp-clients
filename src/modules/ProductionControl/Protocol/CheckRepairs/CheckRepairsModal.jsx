...
const CheckRepairsModal = ({ open, onCancel, onSubmit, initialValues }) => {
    ...
    >
      <Form form={form} layout="vertical">
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item name="name" label="Đánh giá sửa chữa" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          {/* <Col span={12}>
...
export default CheckRepairsModal;