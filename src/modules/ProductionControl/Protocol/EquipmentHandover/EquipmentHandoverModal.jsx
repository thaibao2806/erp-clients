...
const EquipmentHandoverModal = ({ open, onCancel, onSubmit, initialValues }) => {
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="Loại biên bản"
              rules={[
                { required: true, message: "Vui lòng chọn loại biên bản" },
              ]}
            >
              <Select placeholder="Chọn loại biên bản">
                <Option value="BG">Bàn giao</Option>
                <Option value="TH">Thu hồi</Option>
              </Select>
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item name="name" label="Nội dung bàn giao, thu hồi">
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
...
export default EquipmentHandoverModal;