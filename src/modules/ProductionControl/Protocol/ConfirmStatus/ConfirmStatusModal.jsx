...
const ConfirmStatusModal = ({ open, onCancel, onSubmit, initialValues }) => {
    ...
    >
      <Form form={form} layout="vertical">
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item name="name" label="Nội dung bàn giao" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
          ...
          <Col span={12}>
            <Form.Item name="name" label="Giám sát kỹ thuật" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item name="name" label="QL CCDC" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
          ...
          <Col span={12}>
            <Form.Item name="name" label="Tình trạng thiết bị" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
            <Form.Item name="name" label="Nội dung sửa chữa" rules={[{ required: true }]}> 
              <Input />
            </Form.Item>
          </Col>
          <Col span={12}>
