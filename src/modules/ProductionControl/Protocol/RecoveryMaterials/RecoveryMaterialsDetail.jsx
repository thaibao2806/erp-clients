...
import RecoveryMaterialsModal from "./RecoveryMaterialsModal";

const { Title } = Typography;
const { Panel } = Collapse;

const RecoveryMaterialsDetail = () => {
  const { id } = useParams();
  ...
  return (
    <div style={{ padding: 10 }}>
      <Row justify="space-between" align="middle">
        <Col>
          <Title level={3}>Xem chi tiết biên bản thu hồi vật tư</Title>
        </Col>
        <Col>
          <Dropdown
      ...
      >
        <Panel header="Thông tin sổ kho" key="1">
          <Space direction="vertical" size="middle">
            ...
            <div>Nội dung thu hồi: Tháng 3 - Phòng Nhân sự</div>
...
export default RecoveryMaterialsDetail;
