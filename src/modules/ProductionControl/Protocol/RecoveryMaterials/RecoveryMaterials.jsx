...
const RecoveryMaterials = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "sochungtu",
      render: (text, record) => (
        <Link to={`/pm/de-xuat/bien-ban-thu-hoi-chi-tiet/${record.key}`}>{text}</Link> // ✅ THAY ĐOẠN NÀY
      ),
    },
    {
      title: "Ngày chứng từ",
...
export default RecoveryMaterials;
