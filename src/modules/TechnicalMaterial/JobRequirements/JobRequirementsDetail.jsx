    ...
    if (isMobile) {
      return (
        <Space direction="vertical" size="middle" style={{ width: "100%" }}>
          ...
          <div>
            <strong>Đơn vị quản lý:</strong> {data.managementUnit || ""}
          </div>
          <div>
            <strong>Bộ phận:</strong> {data.department || ""}
          </div>
          <div>
            <strong>Lệnh sửa chữa:</strong> {data.repairOrderCode || ""}
          </div>
    ...
    >
      <Row justify="space-between" align="middle" gutter={[16, 16]}>
        <Col xs={24} sm={16} md={18} lg={20}>
          ...
          >
            Xem chi tiết phiếu yêu cầu công việc
          </Title>
        </Col>
...
export default JobRequirementsDetail;
