  ...
  const mobileColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <Link
            to={`/tm/yeu-cau-cong-viec-chi-tiet/${record.id}`}
          ...
          >
            <div style={{ flex: 1 }}>
              ...
              >
                ...
                <Link
                  to={`/tm/yeu-cau-cong-viec-chi-tiet/${item.id}`}
                  style={{ fontWeight: 600, fontSize: 14 }}
              ...
              <div style={{ fontSize: 12, color: "#666", marginBottom: 2 }}>
                <strong>Đơn vị quản lý sd:</strong> {item.managementUnit}
              </div>
              ...
              <div style={{ fontSize: 12, color: "#666", marginBottom: 2 }}>
                <strong>Lệnh sửa chữa:</strong> {item.repairOrderCode}
              </div>
