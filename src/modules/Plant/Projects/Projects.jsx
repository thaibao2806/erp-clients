...
const Projects = () => {
  ...
  const columns = [
    ...
    
    {
      ...
      fixed: isMobile ? "left" : false,
      render: (text, record) => (
        <Link to={`/pl/project-chi-tiet/${record.id}`}>{text}</Link>
      ),
    },
    {
      title: "Ngày chứng từ",
  ...
  const mobileColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <Link 
            to={`/pl/project-chi-tiet/${record.id}`}
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12} md={8}>
          ...
          <Input
            ...
            onChange={(e) =>
              handleFilterChange("assignedPerson", e.target.value)
            }
            size={isMobile ? "small" : "default"}
          />
        </Col>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", marginBottom: 4 }}>
                ...
                <Link 
                  to={`/pl/project-chi-tiet/${item.id}`}
                  style={{ fontWeight: 600, fontSize: 14 }}
              ...
              <div style={{ fontSize: 12, color: "#666", marginBottom: 2 }}>
                  <strong>Đơn vị:</strong> {item.department}
                </div>
              <div style={{ fontSize: 12, color: "#666", marginBottom: 2 }}>
              ...
              <div style={{ fontSize: 12, color: "#666", marginBottom: 2 }}>
                <strong>Về việc:</strong> {item.planContent}
              </div>
    ...
    <div style={{ padding: isMobile ? 8 : 5}}>
      ...
      >
        <h1 style={{ margin: 0,fontSize: isMobile ? 18 : 24,
          flex: isMobile ? "1 1 100%" : "auto" }}>Dự án</h1>
        {isMobile ? (
          <Space size="small">
            <Button
              icon={<FilterOutlined />}
        ...
        <Space size={isTablet ? "small" : "default"} >
          <Tooltip title="Tìm kiếm" >
            <Button
              ...
              style={{ background: "#e6f4fb", color: "#0700ad",marginRight: "5px" }}
              size={isTablet ? "small" : "default"}
            />
          </Tooltip>
          <Tooltip title="Thêm">
            <Button onClick={handleAdd} icon={<PlusOutlined />} style={{ background:"#e6f4fb", color:"#0700ad",marginRight: "5px"  }} size={isTablet ? "small" : "default"}/>
          </Tooltip>
          <Tooltip title="Xóa">
            <Button
              icon={<DeleteOutlined />}
          ...
          <Tooltip title="Xuất excel">
            <Button icon={<FileExcelOutlined />} onClick={handleExportExcel} style={{ background:"#e6f4fb", color:"#0700ad" }} size={isTablet ? "small" : "default"}
                disabled={selectedRowKeys.length === 0}/>
          </Tooltip>
        </Space>
        )}
