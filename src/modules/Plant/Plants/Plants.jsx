...
const Plants = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      fixed: isMobile ? "left" : false,
      render: (text, record) => (
        <Link to={`/pl/ke-hoach/ke-hoach-chi-tiet/${record.id}`}>{text}</Link>
      ),
    },
    {
      title: "Ngày chứng từ",
  ...
  const mobileColumns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <Link 
            to={`/pl/ke-hoach/ke-hoach-chi-tiet/${record.id}`}
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "center", marginBottom: 4 }}>
                ...
                <Link 
                  to={`/pl/ke-hoach/ke-hoach-chi-tiet/${item.id}`}
                  style={{ fontWeight: 600, fontSize: 14 }}
    ...
    <div style={{ padding: isMobile ? 8 : 5}}>
      ...
      >
        <h1 style={{ margin: 0,fontSize: isMobile ? 18 : 24,
          flex: isMobile ? "1 1 100%" : "auto" }}>Kế hoạch</h1>
        {isMobile ? (
          <Space size="small">
            <Button
              icon={<FilterOutlined />}
        ...
        <Space size={isTablet ? "small" : "default"}>
          ...
          <Tooltip title="Thêm">
            <Button onClick={handleAdd} icon={<PlusOutlined />} style={{ background:"#e6f4fb", color:"#0700ad" }} size={isTablet ? "small" : "default"}/>
          </Tooltip>
          <Tooltip title="Xóa">
            <Button
              icon={<DeleteOutlined />}
