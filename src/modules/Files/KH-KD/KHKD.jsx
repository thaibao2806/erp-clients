// ✅ FULL FRONTEND CODE HOÀN CHỈNH — KHKD.jsx
...
const KHKD = () => {
  ...
  const fetchData = async () => {
    const res = await processApi.getByModule("KHKD");
  ...
  useEffect(() => {
    if(user.data?.department === "KHKD" || user.data?.department === "ADMIN" || user.data?.department === "BGD") {
      fetchData();
    }
  }, []);
